...
namespace TatumIO.Net
{
    ...
    public class TatumIOV3Endpoints
    {
        ...
        public static IEndpointData TRONBlockchainUrl => new EndpointSite($"{ServiceUrl.BaseUrl}/tron");
        public static IEndpointData BlockchainUrl => new EndpointSite($"{ServiceUrl.BaseUrl}/blockchain");
    }
