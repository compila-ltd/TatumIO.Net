...
{
    internal class LTCBlockchainOperations : IUTXOBlockchainOperations
    {
        private readonly UTXOGenericBlockchainHttpApiClient _client;

        public LTCBlockchainOperations(string apiKey)
        {
            _client = new LTCBlockchainHttpApiClient(TatumIOV3Endpoints.UTXOBlockchainUrl, apiKey);
        }
